...
const TacticalBackpack = ({ children }) => {
  ...
  const [ listTacticalBackpack, setListTacticalBackpack ] = useState({
    "Z-09": [
      {
        name: 'Z-09',
        image: Z09,
          ...
          <div className="row">
            ...
            <div className="col-12">
              <Tabs defaultActiveKey="Z-09" className="subcat">
                {
                  Object.keys(listTacticalBackpack).map((key, keyIdx) => (
                    <Tab eventKey={key} title={key} key={keyIdx}>
                      <div className="row">
                        {
                          listTacticalBackpack[key].map((tacticalBackpack, tacticalBackpackIdx) => (
                            <div className="col-12 col-md-6 col-lg-4" key={tacticalBackpackIdx}>
                              <Link to="/products/soldier-defense-equipment/product-details" state={tacticalBackpack}>
                                <ProductCard data={tacticalBackpack}></ProductCard>
                              </Link>
                            </div>
                          ))
                        }
